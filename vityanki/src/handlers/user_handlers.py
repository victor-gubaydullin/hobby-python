...
from services.user_services import process_start_command, process_interface_language_selection, process_main_menu_trigger, process_settings_trigger, process_about_trigger, process_settings_language_selection, process_help_trigger
...
async def help_handler(callback: CallbackQuery):
    reply_text, reply_keyboard = await process_help_trigger(callback)
